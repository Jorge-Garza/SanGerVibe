<main class="sangervibe">
    <h2 class="sangervibe__heading"><?php echo $titulo; ?></h2>
    ...
    <div class="sangervibe__grid">
        ...
        <div class="sangervibe__contenido">
            <p class="sangervibe__texto">
                Ubicadas en Espinazo, Mina, Nuevo León, las Aguas Termales de San Gerardo han sido un destino de descanso y renovación durante generaciones. Conocidas por sus aguas ricas en minerales y su conexión con la energía del lugar, este espacio ofrece a los visitantes un refugio para la relajación y el bienestar.
            </p>
