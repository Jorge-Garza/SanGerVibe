...
class Email {
    ...
    public function enviarConfirmacion() {
         ...
         $mail->setFrom('jorgegarza.its@gmail.com');
         ...
         $contenido = '<html>';
         $contenido .= "<p><strong>Hola " . $this->nombre .  "</strong> Has Registrado Correctamente tu cuenta en SanGerVibe; pero es necesario confirmarla</p>";
